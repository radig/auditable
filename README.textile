...
* *userModel* Uma string com o nome do Modelo que armazena os usuários do sistema;
...
bc. App::import('Vendor', 'Auditable.AuditableConfig');
...
* Compatível com CakePHP 1.3 (há branch para versão 2.x)
